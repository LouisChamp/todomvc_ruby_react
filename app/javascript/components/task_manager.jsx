  ...
  <>
  	<section className="todoapp">
  		<header className="header">
  			<h1>todos</h1>
  			<input className="new-todo" placeholder="What needs to be done?" autoFocus onKeyUp={handleEnterPress()}/>
  		</header>
  		...
  		<section className="main">
  			...
  			<ul className="todo-list">
  				...
  				<li className={classNames({completed: task.completed})} key={task.id}>
  					<div className="view">
  						<input className="toggle" type="checkbox" checked onChange={() => handleToggleCheck(task.id)} />
